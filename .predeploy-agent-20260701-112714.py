...
async def entrypoint(ctx: agents.JobContext) -> None:
    ...
    if os.getenv("OPENER_ALREADY_SAID", "0") in ("1", "true", "True"):
        base_instructions += (
            ...
            "caller के पहले जवाब ('हाँ'/'हैलो'/'जी बोलिए') पर सीधे अपने पहले असली सवाल पर जाओ जो उसकी "
            "ज़रूरत/requirement समझे (जैसे area/budget/किसके लिए) — फिर सुनो। हर turn कुछ नया आगे बढ़ाओ, "
            "पिछली बात कभी दोबारा मत बोलो।")
    if recap:
        base_instructions += (
