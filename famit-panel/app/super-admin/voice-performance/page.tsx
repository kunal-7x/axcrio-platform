...
import {
    ...
    n, fmtNum, fmtMs, fmtDateTime, agoMs, TIME_RANGES,
} from "../_obs";
...
function VoicePerfInner() {
    ...
    const [callCampaign, setCallCampaign] = useState<VoiceCallCampaign | null>(null);
    ...
    const openDetail = useCallback(async (callId: string) => {
        ...
        try {
            ...
            setCallCampaign(b.campaign && b.campaign.id ? b.campaign : null);
                                                ...
                                                <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                                                    <div>
                                                        <div className="flex items-center gap-2 flex-wrap">
                                                            ...
                                                            {/* #22: the campaign's script category (sales/consultative/…) for this call */}
                                                            {callCampaign?.category_label && (
                                                        ...
                                                        <div className="text-caption text-t-tertiary">
                                                            ...
                                                            {callCampaign?.name ? <> · {callCampaign.name}</> : callDetail.campaign_id ? <> · {String(callDetail.campaign_id)}</> : null}
