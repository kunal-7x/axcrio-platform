...
//
// Per the design system: ONE page title via `<Layout title="AI Manager">`, THREE
// plain tabs using the reference `Tabs` rhythm — Home / Try it / Setup. No
// eyebrow, no subtitle, no pill-rail, no Command Center. Home folds in the old
// Overview + Command History + Approvals; Try it is the test console; Setup folds
// in Setup + Capabilities + Team. Risk is shown as Safe / Needs approval / Blocked
// (plain language), never raw L0–L4 codes in the primary UI.
//
// All data wiring stays in _lib.ts; the three tab bodies are _home/_tryit/_setup.
...
const TABS: (TabsOption & { key: string })[] = [
    ...
    { id: 2, name: "Try it", key: "tryit" },
    { id: 3, name: "Setup", key: "setup" },
];
