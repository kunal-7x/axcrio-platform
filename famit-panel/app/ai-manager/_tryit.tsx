                ...
                <Card
                    ...
                    headContent={
                        <div className="ml-auto flex items-center gap-2">
                            <select
                                value={channel}
                                onChange={(e) => setChannel(e.target.value as AimChannel)}
                                className="h-8 px-3 pr-7 border border-s-stroke2 rounded-full text-caption text-t-secondary outline-none bg-transparent transition-colors hover:border-s-highlight focus:border-s-focus appearance-none"
                            >
                                {AIM_CHANNELS.map((c) => (
