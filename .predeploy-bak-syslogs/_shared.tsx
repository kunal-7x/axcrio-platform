...
const ADMIN_TABS = [
    ...
    // Credits control — fleet credit analytics, manual grants, + the editable service
    // costing matrix (basis cost + margin per service). Backed by /credits/admin/*.
    ...
    // System Logs — white-labeled error/event observability (backed by /admin/logs*).
