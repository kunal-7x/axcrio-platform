...
def _build_sales_instructions(fields: dict, recap: str, caller_name: str,
    ...
    inbound_override = (
        ...
        "3. LANGUAGE = CASUAL HINGLISH: speak a natural, easy English-Hindi mix the way a real Indian "
        "salesperson talks on the phone — light, friendly, conversational. Do NOT speak heavy/formal "
        "Devanagari Hindi or long literary sentences. Short, casual lines: 'Haan ji, ye 3 BHK hai, "
        "price lagbhag X se start hoti hai — aap kaunsa configuration dekh rahe the?'. Match the "
        "caller: if they speak pure English, reply in English; if pure Hindi, lean Hindi; default to "
        "easy Hinglish. Keep EVERY turn to one or two short sentences, then STOP and listen.\n"
