...
function ProposeForm({
    ...
    const OBJECTIVE_OPTS = ADS_OBJECTIVES.map((o, i) => ({
        id: i,
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <Select
                            className="w-full"
                            classButton="!h-11"
                            value={OBJECTIVE_OPTS.find((o) => o.value === objective) ?? null}
                            options={OBJECTIVE_OPTS}
                            onChange={(o) => setObjective(OBJECTIVE_OPTS[o.id].value as AdsObjective)}
                        />
                    </div>
                    <div>
