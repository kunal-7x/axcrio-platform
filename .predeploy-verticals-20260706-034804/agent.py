...
async def entrypoint(ctx: agents.JobContext) -> None:
    ...
    _el_tts = elevenlabs.TTS(
        ...
        voice_id=(fields.get("voice_id") or _voice_cfg("voice_id", "") or os.getenv("ELEVENLABS_VOICE_ID", "QTKSa2Iyv0yoxvXY2V8a")),
    ...
    if _tts_provider == "sarvam":
        try:
            _bulbul = sarvam.TTS(
                ...
                speaker=(_voice_cfg("sarvam_tts_speaker", "") or os.getenv("SARVAM_TTS_SPEAKER", "anushka")),
