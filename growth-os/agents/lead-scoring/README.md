...
## Purpose
★ Feeds the flagship: score 0-100 + tier + reasons <=15min of any signal; v1 transparent heuristic; features ALWAYS stored (§9.5). Emits lead.scored.
...
## uv workspace
A `pyproject.toml` (package `growth_os_lead_scoring`) makes this a uv workspace member
