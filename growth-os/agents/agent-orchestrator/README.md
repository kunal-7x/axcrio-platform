...
## Purpose
Research War Room = Temporal workflow fanning out TYPED agent activities (12 roster agents) + a Synthesizer -> CIB (§9.2/§9.3).
...
## uv workspace
A `pyproject.toml` (package `growth_os_agent_orchestrator`) makes this a uv workspace member
